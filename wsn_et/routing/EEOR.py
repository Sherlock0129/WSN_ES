...
def _expected_cost_given_fwd(u_id, Fwd_ids, C, neighbor_map, node_dict):
    ...
    # 计算 alpha, rho
    prod = 1.0
    w_u = 0.0  # 固定功率: 用达到最远Fwd的最小功率 or 统一常数。这里取到最远邻居的最小可达功率
    max_d = 0.0
    ...
    C_h = w_u / rho           # 论文式(2) 发射到“至少一人收到”的期望发射能量
